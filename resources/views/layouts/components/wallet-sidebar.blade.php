                            ...
                            <div class="trad-svg">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#28BE9D" />
                                    <path
                                        d="M12.8002 19.7504H11.2002C10.2402 19.7504 9.4502 18.9604 9.4502 18.0004V6.19043C9.4502 5.23043 10.2402 4.44043 11.2002 4.44043H12.8002C13.7602 4.44043 14.5502 5.23043 14.5502 6.19043V18.0004C14.5502 18.9604 13.7602 19.7504 12.8002 19.7504ZM11.2002 5.94043C11.0602 5.94043 10.9502 6.05043 10.9502 6.19043V18.0004C10.9502 18.1404 11.0602 18.2504 11.2002 18.2504H12.8002C12.9402 18.2504 13.0502 18.1404 13.0502 18.0004V6.19043C13.0502 6.05043 12.9402 5.94043 12.8002 5.94043H11.2002Z"
                                        fill="#28BE9D" />
                                    <path
                ...
                <div class="card order remove-radius mb-0">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start pb-3 dz-border">
                            <div>
                                <svg class="me-3" width="49" height="49" viewBox="0 0 49 49" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M46 25C46 37.1503 36.1503 47 24 47C11.8497 47 2 37.1503 2 25C2 12.8497 11.8497 3 24 3C36.1503 3 46 12.8497 46 25ZM4.2 25C4.2 35.9352 13.0648 44.8 24 44.8C34.9352 44.8 43.8 35.9352 43.8 25C43.8 14.0648 34.9352 5.2 24 5.2C13.0648 5.2 4.2 14.0648 4.2 25Z"
                                        fill="#E3E3E3" />
                                    <path
                                        d="M24.5 0C27.7174 3.8367e-08 30.9033 0.633711 33.8757 1.86495C36.8482 3.09619 39.5491 4.90085 41.8241 7.17589C44.0992 9.45092 45.9038 12.1518 47.135 15.1243C48.3663 18.0967 49 21.2826 49 24.5H41.65C41.65 22.2478 41.2064 20.0177 40.3445 17.937C39.4827 15.8562 38.2194 13.9656 36.6269 12.3731C35.0344 10.7806 33.1438 9.51733 31.063 8.65547C28.9823 7.7936 26.7522 7.35 24.5 7.35V0Z"
                                        fill="#27AE60" />
                                </svg>
                            </div>
                            <div class="">
                        ...
                        <div class="d-flex align-items-center py-3 dz-border">
                            <div>
                                <svg class="me-3" width="49" height="49" viewBox="0 0 49 49" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M46 24C46 36.1503 36.1503 46 24 46C11.8497 46 2 36.1503 2 24C2 11.8497 11.8497 2 24 2C36.1503 2 46 11.8497 46 24ZM4.2 24C4.2 34.9352 13.0648 43.8 24 43.8C34.9352 43.8 43.8 34.9352 43.8 24C43.8 13.0648 34.9352 4.2 24 4.2C13.0648 4.2 4.2 13.0648 4.2 24Z"
                                        fill="#E3E3E3" />
                                    <path
                                        d="M24.5 0C28.8412 5.17688e-08 33.1045 1.15351 36.8535 3.34247C40.6025 5.53143 43.7025 8.67723 45.8363 12.4579C47.9701 16.2385 49.061 20.5183 48.9974 24.859C48.9338 29.1998 47.7179 33.4457 45.4742 37.1622C43.2306 40.8787 40.0397 43.9323 36.2281 46.0105C32.4166 48.0886 28.1214 49.1167 23.782 48.9895C19.4426 48.8623 15.215 47.5843 11.5318 45.2864C7.84854 42.9885 4.84203 39.7532 2.81996 35.9117L9.32397 32.4882C10.7394 35.1773 12.844 37.442 15.4222 39.0505C18.0005 40.659 20.9598 41.5536 23.9974 41.6426C27.035 41.7317 30.0416 41.012 32.7097 39.5573C35.3778 38.1026 37.6114 35.9651 39.182 33.3636C40.7525 30.762 41.6036 27.7899 41.6482 24.7513C41.6927 21.7128 40.9291 18.717 39.4354 16.0705C37.9418 13.4241 35.7717 11.222 33.1475 9.68973C30.5232 8.15746 27.5389 7.35 24.5 7.35V0Z"
                                        fill="#FD5353" />
                                </svg>
                            </div>
                            <div class="">
                        ...
                        <div class="d-flex align-items-center pt-3">
                            <div>
                                <svg class="me-3" width="50" height="50" viewBox="0 0 50 50" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M47 25C47 37.1503 37.1503 47 25 47C12.8497 47 3 37.1503 3 25C3 12.8497 12.8497 3 25 3C37.1503 3 47 12.8497 47 25ZM5.2 25C5.2 35.9352 14.0648 44.8 25 44.8C35.9352 44.8 44.8 35.9352 44.8 25C44.8 14.0648 35.9352 5.2 25 5.2C14.0648 5.2 5.2 14.0648 5.2 25Z"
                                        fill="#E3E3E3" />
                                    <path
                                        d="M25 0C29.5182 5.38793e-08 33.952 1.22446 37.8299 3.54319C41.7077 5.86191 44.8847 9.18822 47.023 13.1684C49.1613 17.1486 50.181 21.6339 49.9737 26.1474C49.7663 30.6608 48.3396 35.0337 45.8454 38.8011L39.5918 34.6608C41.3377 32.0236 42.3364 28.9626 42.4816 25.8032C42.6267 22.6437 41.9129 19.504 40.4161 16.7179C38.9193 13.9318 36.6954 11.6033 33.9809 9.98023C31.2664 8.35712 28.1628 7.5 25 7.5V0Z"
                                        fill="#FF9F00" />
                                </svg>
                            </div>
                            <div class="">
